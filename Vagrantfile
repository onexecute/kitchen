...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chefcemartinjr-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/onexecute_llc"
  #   chef.validation_client_name = "onexecute_llc-validator"
  #   chef.validation_key_path = ".chef/onexecute_llc-validator.pem"
  # end
end
